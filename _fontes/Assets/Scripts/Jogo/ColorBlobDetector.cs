...
namespace OpenCVForUnityExample
{
    public class ColorBlobDetector
    {
        ...
        // Scalar da posição selecionada
        private static Scalar scalarImg = null;
        ...
        public void VerificaCorPonto(Mat img, Point touchPoint)
        {
            scalarImg = null;
            ...
            using (Mat touchedRegionHsv = new Mat())
            {
                ...
                scalarImg = Core.sumElems(touchedRegionHsv);
                int pointCount = touchedRect.width * touchedRect.height;
                for (int i = 0; i < scalarImg.val.Length; i++)
                    scalarImg.val[i] /= pointCount;

                this.SetHsvColor(scalarImg);
            }
        }

        public static Scalar GetColorPoint()
        {
            return scalarImg;
        }

        public void SetColorPoint(Scalar scalar)
        {
            scalarImg = scalar;
        }
    }
